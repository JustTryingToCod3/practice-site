function BadTherapy () {
  var monit; // Stop copying others and get a personality  
  var flalt; // Stop pretending to be an altruist. We both know you don't care about these people  
  var pet; // You lick the boots of anyone in authority 
  ...
  var extr; // You are the life of the party but no one invited you. Your presence is unneccessary 
  var irr; // You can't cope with how irrelevant you are. You will never be good enough. Stop lying to yourself
  ...
  var pess; //You will never achieve what you want in life because you already know that to be true
