function BadTherapy(score) {
  const messages = [
    ...
    { min: 29, max: 32, text: "You secretly enjoy the pain of others. Stop pretending to be sad and just laugh in their face already." },
    { min: 33, max: 36, text: "You don't enable other people's bad behavior because you're kind. You want to see them destroy themselves so you can save them." },
    { min: 37, max: 40, text: "You love to be the hero, but you'd rather pretend to be the victim than accept when you're the villain." },
    { min: 41, max: 44, text: "You pretend to have it all together, but secretly want someone to save you. Grow up." },
    { min: 45, max: 48, text: "Stop pretending to be an altruist. We both know you don't care about these people." },
    { min: 49, max: 52, text: "There is no reason to pretend you are a person of virtue. You are not." },
    { min: 53, max: 56, text: "I know your kinks are rare, but there's nothing to be ashamed of..." },
    { min: 57, max: 60, text: "You can't cope with how irrelevant you are. You are only good enough to be a disappointment." },
    { min: 61, max: 64, text: "You will never escape the broke mentality." },
    { min: 65, max: 68, text: "Happiness is chasing you, but you are fast." },
    { min: 69, max: 72, text: "You aren't an introvert. You just say that when you don't like the person you're talking to." },
    ...
    { min: 85, max: 88, text: "You lie to others, lie to yourself, and even your heart lies to you." },
