function BadTherapy(score) {
  const messages = [
    ...
    { min: 33, max: 36, text: "You pretend to have it all together, but secretly want someone to save you. Grow up." },
    { min: 37, max: 40, text: "Stop pretending to be an altruist. We both know you don't care about these people." },
